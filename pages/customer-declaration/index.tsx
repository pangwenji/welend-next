...
class ImportantNotices extends React.Component<Props, State> {
  ...
  public render(): any {
    ...
    return (
      <Layout
        {...this.props}
        metaTitle={t("common:meta-data:title:customer-declaration")}
        metaPath="customer-declaration"
      >
        <div
          className={css`
        ...
        >
          ...
          >
            {t("legal:customer-declaration:title")}
          </div>
          <div
            className={css`
          ...
          >
            <div dangerouslySetInnerHTML={{ __html: t("legal:customer-declaration:content") }} />
          </div>
        </div>
      </Layout>
    );
